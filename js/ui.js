...
function populateSelect(selectId, items, valueField, textField, defaultOptionText = "Seleccionar...") {
    ...
    div.innerHTML = `
        ...
        <div class="col-4">
            <select class="form-select form-select-sm stat-type">
                <option value="goal" ${stat && stat.type === 'goal' ? 'selected' : ''}>Gol</option>
                <option value="assist" ${stat && stat.type === 'assist' ? 'selected' : ''}>Asistencia</option>
                <option value="yellow_card" ${stat && stat.type === 'yellow_card' ? 'selected' : ''}>Tarjeta Amarilla</option>
                <option value="red_card" ${stat && stat.type === 'red_card' ? 'selected' : ''}>Tarjeta Roja</option>
            </select>
        </div>
        <div class="col-2">
